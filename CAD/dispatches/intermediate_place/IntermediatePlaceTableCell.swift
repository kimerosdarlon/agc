//
//  IntermediatePlaceTableCell.swift
//  CAD
//
...
class IntermediatePlaceTableCell: UITableViewCell {
    ...
    override func didMoveToSuperview() {
        ...
        NSLayoutConstraint.activate([
            ...
            inputText.trailingAnchor.constraint(equalTo: checkbox.leadingAnchor, constant: -10),
